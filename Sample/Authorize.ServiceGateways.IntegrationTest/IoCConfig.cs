using Authorize.ServiceGateways.IntegrationTest.Providers;
using Authorize.ServiceGateways.IoC;
...
namespace Authorize.ServiceGateways.IntegrationTest
{
    public class IoCConfig
    {
        ...
        public static IServiceProvider GetServiceProvider(TestContext context)
        {
            ...
            serviceCollection.AddAutorizeGatewayWithCache(Configuration, "AuthorizeApi");
